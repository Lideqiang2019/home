...
function current_scatter_show(){
    ...
    .then(axios.spread(function(acct, perms) {
        ...
        document.getElementById("current_btn_text").innerHTML = "Diagnosis by " + latestDate.date;
        document.getElementById('table_time').innerHTML = "Data updated on " + latestDate.date;
...
function display_time() {
    ...
    $.ajax({
        ...
        success: function(req) {
            ...
            for (var v in req) {
                var v2 = Number(v) + 1;
                source = source + "<tr><th scope='row' style='text-align:right;'>" + v2 + "</th><td>" + req[v]["Country"] + "</td><td  style='text-align:right; width: 35%;'>" + req[v]["Peak time"] + "</td></tr>";
                xs.push(req[v]["Country"])
